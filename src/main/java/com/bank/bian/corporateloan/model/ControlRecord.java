package com.bank.bian.corporateloan.model;
...
/**
 * The BIAN control record for this service domain: "Corporate Loan Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Corporate Loan Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Corporate Loan Facility Fulfillment Arrangement";
